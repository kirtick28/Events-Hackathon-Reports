                  ...
                  {user.role === 'innovation' ? (
                    <>
                      <motion.button
                        ...
                        className="w-full py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow"
                      >
                        Approve Event
                      </motion.button>
                      <motion.button
                        ...
                        className="w-full py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow"
                      >
                        Reject Event
                      </motion.button>
                    </>
                  ) : (
                    <div className="w-full py-2.5 bg-yellow-100 text-yellow-800 rounded-xl text-center">
                ...
                <div className="space-y-3">
                  {user.role === 'innovation' ? (
                    ...
                    <motion.button
                      ...
                      className="w-full py-2.5 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow"
                    >
              ...
              {event.status === 'draft' && (
                <div className="space-y-3">
                  <Link
                    ...
                    className="block w-full py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow text-center"
                  >
                    Edit Draft
                  </Link>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => handleStatusChange('pending')}
                    className="w-full py-2.5 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow"
                  >
                    Submit for Approval
                  </motion.button>
                </div>
              ...
              {event.status === 'approved' && (
                <div className="space-y-3">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow"
                  >
                    View Registrations
                  </motion.button>
                  {(user.role === 'innovation' || user._id === event.createdBy._id) && (
                    <Link
                      to={`${basePath}/events/${eventId}/edit`}
                      className="block w-full py-2.5 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow text-center"
                    >
                      Edit Event
                    </Link>
                  )}
              ...
              <dl className="space-y-3">
                <div>
                  ...
                  <dd className="font-medium">
                    {event.customType || event.type.charAt(0).toUpperCase() + event.type.slice(1)}
                  </dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd className="font-medium">
                    {event.eligibility.teamSize.min === event.eligibility.teamSize.max
          ...
          <div className="lg:col-span-3">
            <Tab.Group>
              <Tab.List className="flex space-x-1 bg-white p-1 rounded-2xl shadow-lg mb-6">
                {['Overview', 'Guidelines', 'Schedule', 'Prizes', 'Contacts'].map(
                  (tab) => (
                    <Tab
                      key={tab}
                      className={({ selected }) =>
