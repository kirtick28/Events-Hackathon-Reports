...
const Departments = () => {
  ...
  const fetchDepartments = async () => {
    try {
      const response = await api.get('/departments?category=student');
  ...
  const handleSubmitDepartment = async () => {
    try {
      ...
      setShowModal(false);
      setNewDepartment({ name: '', description: '', category: 'student' });
  ...
  const handleEdit = (department) => {
    ...
    setNewDepartment({
      ...
      category: department.category || 'student'
    });
    setShowModal(true);
  };
        ...
        >
          <div className="flex-1 max-w-2xl relative">
            ...
            <input
              ...
              placeholder="Search student departments..."
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-yellow-500 to-blue-500 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow"
          >
